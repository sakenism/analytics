...
class JsPiscine:
	...
	def steps(self):
		z01 = database.Hasura(os.getenv("HASURA_ADDR"), os.getenv("HASURA_SCRT"))
		js_id = "3402"
		children_of_js = get_children_array(children_of_js_Query % js_id)

		children_of_child = {}
		str_children_of_js = get_children_str(children_of_js)

		grandchildren_of_js = get_children_array(children_of_js_Query % str_children_of_js)
		str_grandchildren_of_js = get_children_str(grandchildren_of_js)
		map_ans = {}
